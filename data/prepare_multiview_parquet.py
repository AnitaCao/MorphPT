...
META_2P5X_DIR = Path("/hpc/group/jilab/boxuan/meta/2.5x")
META_10X_DIR  = Path("/hpc/group/jilab/boxuan/meta/10x")
SPATIAL_DIR   = Path("/hpc/group/jilab/hz/MorphPT/CellImageNet/spatial")
IMG_BASE      = Path("/hpc/group/jilab/boxuan/image")
