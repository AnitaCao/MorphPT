...
Usage:
    srun -p h200ea -A h200ea --cpus-per-task=16 --mem=64G --time=04:00:00 \\
        python preprocess_memmap.py \\
            --parquet_dir /hpc/group/jilab/rz179/MorphPT_MOE/prepared/splits_v3_seed1337 \\
            --class_map   /hpc/group/jilab/rz179/MorphPT_MOE/prepared/splits_v3_seed1337/coarse_to_id.json \\
            --out_dir     /hpc/group/jilab/rz179/MorphPT_MOE/cache_224 \\
