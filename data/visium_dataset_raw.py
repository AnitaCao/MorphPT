...
class VisiumHDPredictionDatasetRaw(Dataset):
    """
    Args:
        root_dir         : directory with the raw VisiumHD crops/data
                           (override default via the VISIUM_ROOT env var)
    ...
    def __init__(
        self,
        root_dir:         str | Path = os.environ.get("VISIUM_ROOT", "data/visiumHD"),
        morphpt_data_dir: str | Path = os.environ.get("VISIUM_MORPHPT_DATA", "data/visiumHD"),
