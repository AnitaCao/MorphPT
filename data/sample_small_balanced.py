...
OUT_PARQUET = Path("/hpc/group/jilab/rz179/MorphPT_MOE/prepared/small_balanced.parquet")
OUT_MANIFEST = Path("/hpc/group/jilab/rz179/MorphPT_MOE/prepared/small_balanced_manifest.json")
