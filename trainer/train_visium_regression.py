...
def get_parser():
    ...
    p.add_argument("--cache_dir",   type=str,
                   default=os.environ.get("VISIUM_CACHE", "cache_visium"))
    # Raw args
    p.add_argument("--root_dir",    type=str,
                   default=os.environ.get("VISIUM_ROOT", "data/visiumHD"))
    p.add_argument("--morphpt_data_dir", type=str,
                   default=os.environ.get("VISIUM_MORPHPT_DATA", "data/visiumHD"))
